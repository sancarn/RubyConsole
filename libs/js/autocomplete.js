  ...
  .then(function(){
    ...
    langTools.setCompleters([{
      getCompletions: function(editor,session,pos,prefix,callback){
        ...
        //like . and ::
        while(!chars[start_col].match(/[^A-Za-z0-9_\.:@$]/) && start_col != 0){
          start_col--
        }
        ...
        if(line.substr(-1)=="."){
          ...
          Ruby.eval(objectSpecified + ".methods",function(response){
          ...
          Ruby.eval(objectSpecified + ".constants",function(response){
            if(response.type=="ERROR") return callback(null,null);
